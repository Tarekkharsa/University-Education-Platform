          ...
          choice_list: [
            {
              ...
              correct: data?.answer === 'choice_one' ? 1 : 0,
            },
            {
              choice_text: data?.choice_two,
              correct: data?.answer === 'choice_two' ? 1 : 0,
            },
            {
              choice_text: data?.choice_three,
              correct: data?.answer === 'choice_three' ? 1 : 0,
            },
            {
              choice_text: data?.choice_four,
              correct: data?.answer === 'choice_four' ? 1 : 0,
            },
            {
              choice_text: data?.choice_five,
              correct: data?.answer === 'choice_five' ? 1 : 0,
            },
          ],
        },
      ],
